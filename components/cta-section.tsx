...
export default function CTASection() {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-r from-primary/20 via-secondary to-primary/20 py-20">
      ...
      <div className="relative mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
        ...
        <div className="mt-12 flex flex-col items-center gap-2 sm:flex-row sm:justify-center sm:gap-8">
